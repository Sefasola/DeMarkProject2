...
class MyStory3 extends StatefulWidget {
  late int markerId;
  late int userId;
  MyStory3(int userId, int markerId) {
    this.userId = userId;
    this.markerId = markerId;
  }

  @override
  State<MyStory3> createState() => _MyStory3State();
}
                ...
                ListTile(
                  leading: CircleAvatar(
                    backgroundImage: NetworkImage(
                      "https://img.piri.net/mnresize/720/-/resim/upload/2016/04/01/11/29/c808cb77osmanliwallpaerlari13.jpg",
                    ),
                  ),
